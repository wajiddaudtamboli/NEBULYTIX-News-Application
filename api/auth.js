...
const connectDB = async (retries = 2) => {
    ...
    if (!mongoUri) {
        throw new Error('MONGODB_URI not configured. Go to Vercel Dashboard > Settings > Environment Variables.');
    }
...
const Admin = (mongoose.models.AuthAdmin || mongoose.model('AuthAdmin', adminSchema, 'admins'));
