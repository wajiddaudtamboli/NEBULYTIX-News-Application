...
const Media = (mongoose.models.Media || mongoose.model<IMedia>('Media', mediaSchema)) as Model<IMedia>;
const Folder = (mongoose.models.Folder || mongoose.model<IFolder>('Folder', folderSchema)) as Model<IFolder>;
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    if (req.method === 'PUT' && id) {
      ...
      if (mediaFolder) updateData.folder = mediaFolder;
